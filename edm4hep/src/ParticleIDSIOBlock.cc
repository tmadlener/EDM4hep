...
#include "edm4hep/ParticleIDSIOBlock.h"
...
void ParticleIDSIOBlock::read(sio::read_device& device, sio::version_type) {

  auto* dataVec = static_cast<edm4hep::ParticleIDCollection*>(_col)->_getBuffer();
...
void ParticleIDSIOBlock::write(sio::write_device& device) {
