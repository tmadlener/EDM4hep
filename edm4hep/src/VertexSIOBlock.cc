...
#include "edm4hep/VertexSIOBlock.h"
...
void VertexSIOBlock::read(sio::read_device& device, sio::version_type) {

  auto* dataVec = static_cast<edm4hep::VertexCollection*>(_col)->_getBuffer();
...
void VertexSIOBlock::write(sio::write_device& device) {
