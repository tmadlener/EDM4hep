...
#include "edm4hep/TrackSIOBlock.h"
...
void TrackSIOBlock::read(sio::read_device& device, sio::version_type) {

  auto* dataVec = static_cast<edm4hep::TrackCollection*>(_col)->_getBuffer();
